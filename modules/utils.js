...
const Utils = {
    ...
    getGetFlyLink(customer, fontSize = '14px') {
        ...
        return `<a href="${customer.getfly_url}" target="_blank" title="Mở trên GetFly" style="text-decoration:none; margin-left:4px; font-size:${fontSize}; color:var(--text-muted); display:inline-flex; align-items:center;">
